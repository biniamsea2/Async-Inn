...
namespace AyncINN.Controllers
{
    public class RoomAmenitiesController : Controller
    {
        ...
        private readonly IAmenitiesManager _amenity;
        ...
        {
            var roomAmenities = _room.GetRoomAmenitiesByID(roomId);
...
//        public async Task<IActionResult> Create([Bind("ID,AmenitiesID,RoomID")] RoomAmenities roomAmenities)
//        {
